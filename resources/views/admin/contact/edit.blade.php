...
<form action="{{ route('contacts.update',$contact->id) }}" method="POST">
    ...
    <div class="mb-3">
        ...
        <input type="text" name="name"  placeholder="اسم الخدمة" class="ckeditor form-control" value="{{$contact->name}}">
    </div>
   ...
   <select class="form-control" name="icon">
    ...
    <div class="mb-3">
        ...
        <input type="text" name="link"  placeholder="اسم الخدمة" class="form-control"  value="{{$contact->link}}">
    </div>
